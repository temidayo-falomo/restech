    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center space-y-8">
          ...
          {/* <div className="max-w-md mx-auto">
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="flex gap-3">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all duration-200 transform hover:scale-105"
                >
                  Notify Me
                </button>
              </form>
            ) : (
              <div className="px-6 py-3 bg-green-500/10 border border-green-500/20 rounded-lg text-green-600 dark:text-green-400 animate-fade-in">
        ...
        <div className="flex justify-center space-x-6 pt-8 animate-fade-in-delay-3">
          <a
            href="#"
            className="w-12 h-12 bg-muted rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-200 transform hover:scale-110"
            aria-label="Twitter"
          >
